...
async function restoreData() {
  ...
  try {
    ...
    for (const client of clients) {
      const result = await sql`
        INSERT INTO clients (first_name, last_name, email, phone, address, date_of_birth, notes)
        VALUES (${client.firstName}, ${client.lastName}, ${client.email}, ${client.phone}, ${client.address}, ${client.dateOfBirth}, ${client.notes})
        RETURNING id, first_name, last_name
      `;
