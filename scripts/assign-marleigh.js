...
// Assign Marleigh Allwelt the requested services with specified commission rates
...
(async () => {
  const staff = await findStaffByFullName('Marleigh Allwelt');
  if (!staff) {
    console.error('Marleigh Allwelt not found.');
    process.exit(1);
  }
