 ...
 */
export function validatePasswordStrength(password, policy = DEFAULT_PASSWORD_POLICY) {
    const errors = [];
    if (!password) {
 ...
 */
export function shouldEnforcePasswordPolicy() {
 ...
 */
export function getPasswordRequirements(policy = DEFAULT_PASSWORD_POLICY) {
    const requirements = [];
