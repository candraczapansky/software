...
export function registerReceiptRoutes(app: Express, storage: IStorage) {
  // Send receipt via email
  app.post("/api/send-receipt-email", asyncHandler(async (req: Request, res: Response) => {
  ...
  app.post("/api/send-receipt-sms", asyncHandler(async (req: Request, res: Response) => {
    const context = getLogContext(req);
