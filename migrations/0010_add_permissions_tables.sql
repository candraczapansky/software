...
CREATE INDEX IF NOT EXISTS idx_permission_group_mappings_group_id ON permission_group_mappings(group_id);
CREATE INDEX IF NOT EXISTS idx_permission_group_mappings_permission_id ON permission_group_mappings(permission_id);
CREATE INDEX IF NOT EXISTS idx_user_permission_groups_user_id ON user_permission_groups(user_id);
CREATE INDEX IF NOT EXISTS idx_user_permission_groups_group_id ON user_permission_groups(group_id);
CREATE INDEX IF NOT EXISTS idx_user_direct_permissions_user_id ON user_direct_permissions(user_id);
CREATE INDEX IF NOT EXISTS idx_user_direct_permissions_permission_id ON user_direct_permissions(permission_id);
