...
// Test the structured SMS assistant with correct sequence
async function testStructuredSMSAssistant() {
  console.log('🧪 Testing Structured SMS Assistant (Correct Sequence)\n');
  ...
  const result1 = await assistant.processMessage({
    from: testPhone,
    to: '+1987654321',
  ...
  const result2 = await assistant.processMessage({
    from: testPhone,
    to: '+1987654321',
  ...
  const result3 = await assistant.processMessage({
    from: testPhone,
    to: '+1987654321',
    body: 'tomorrow',
    timestamp: new Date().toISOString(),
  ...
  // Test 4: Time selection (correct message)
  console.log('📱 Test 4: Time selection');
  const result4 = await assistant.processMessage({
    from: testPhone,
    to: '+1987654321',
    body: '9:00 AM',
    timestamp: new Date().toISOString(),
  ...
  // Test 5: Client name
  console.log('📱 Test 5: Client name');
  const result5 = await assistant.processMessage({
    from: testPhone,
    to: '+1987654321',
    body: 'John Smith',
    timestamp: new Date().toISOString(),
  ...
  // Test 6: Client email
  console.log('📱 Test 6: Client email');
  const result6 = await assistant.processMessage({
    from: testPhone,
    to: '+1987654321',
  ...
  // Test 7: Client phone
  console.log('📱 Test 7: Client phone');
  const result7 = await assistant.processMessage({
    from: testPhone,
    to: '+1987654321',
    body: '+1234567890',
    timestamp: new Date().toISOString(),
  ...
  // Test 8: Confirmation
  console.log('📱 Test 8: Confirmation');
  const result8 = await assistant.processMessage({
    from: testPhone,
    to: '+1987654321',
  ...
  console.log('✅ Structured SMS Assistant test completed!');
}

// Run the test
testStructuredSMSAssistant().catch(console.error); 